...
if a_InHome == 1:
    ...
    # a_2: Какая средняя температура в вашем доме?
    a_2_input_AVGTempInRegion = get_input("Какая средняя температура в вашем доме? ", 15, 30)
...
if c_AFlowers == 3:
    # c_3: Выберете желаемый цвет - один или несколько (вводите числа через пробел)
    c_3_SelectAColor = input("Выберете желаемый цвет - один или несколько (вводите названия цветов, через пробел)" + str_all_colors + ":\n")
